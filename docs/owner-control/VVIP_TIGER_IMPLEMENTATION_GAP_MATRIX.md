...
| P01-017 | Repo Hygiene | انتشار نسخ تاريخية مكررة | Git history | completed | 100 | obsolete_candidate_count = 0 | تمت إزالة 63 نسخة بعد إثبات الملفات المرجعية | منخفض | High | P01 | clean-room gate | تقرير التنظيف النهائي | no | no | no |
