...
| Business verification reviewer | Verification queue and submitted business evidence | Review documents, approve/reject with reason, log audit trail | Publish sensitive documents or request passwords/OTP | Access denied on public document exposure |
...
| Business Seller | Business-facing listing workflow and business profile state | Publish/manage own business listings within approved policy | Bypass business verification or owner policy | Access denied on unverified business publish route |
| Personal VIP | Premium browsing and private-contact user experience | Browse, save, and communicate privately within policy | Gain hidden admin privileges | Access denied on admin dashboards |
