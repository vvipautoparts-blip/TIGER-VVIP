...
-- Secure future tables created by the two platform schema owners.
...
-- Secure future sequences for anonymous visitors.
alter default privileges for role postgres in schema public
...
-- New browser-callable database functions must opt in explicitly.
