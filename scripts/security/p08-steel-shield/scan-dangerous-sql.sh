...
declare -A reviewed_migration_hashes=(
  ...
  # Social media boundary: private bucket, parent-post visibility, owner/path-scoped writes,
  # local migration replay, and exact-id/path behavioral proof reviewed with CRITICAL=0.
  # The 19 HIGH findings are expected new-table NOT NULL integrity and RLS policy creation.
  ["supabase/migrations/20260819123000_social_media_boundary.sql"]="15da66a889d5908d57e05188bff6ebbefe39dce96e8e11903046ddb2f2c02d4e"
)
