...
const URL = 'http://127.0.0.1:8080/private-profile.html';
...
let report = '# VVIP TIGER Mobile Private Audit\n\n## Summary\n\n';
...
fs.writeFileSync('reports/vvip-mobile-private-audit.md', report, 'utf8');
console.log(report);
