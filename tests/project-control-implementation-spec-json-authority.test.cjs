...
test("machine-readable historical implementation specification cannot authorize external-deal G17 payment execution", () => {
  const specPath = "project-control/sources/VVIP_TIGER_Global_Implementation_Specification_AR_v2.json";
  ...
  assert.match(row, /HISTORICAL_MACHINE_IMPLEMENTATION_SPECIFICATION/i);
